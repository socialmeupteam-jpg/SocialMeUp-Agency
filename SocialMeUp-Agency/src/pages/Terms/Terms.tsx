        ...
        <div className={styles.container}>
          ...
          >
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Country/State</strong> refers to: Uttar Pradesh, India
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  Service. These Terms and Conditions have been created with the
                  help of the{" "}
                  <a
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to socialmeup.in, accessible
                  from{" "}
                  <a
                    href="https://socialmeup.in/"
            ...
            <h2>Governing Law</h2>
            <p>
              The laws of the Country/State, excluding its conflicts of law
              rules, shall govern these Terms and Your use of the Service. Your
